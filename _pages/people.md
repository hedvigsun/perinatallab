...
{% include new_feature_row id="intro" type="center" %}

{% include new_feature_row %}
{% include new_feature_row id="feature_row2" type="left" %}

{% include new_feature_row id="feature_row3" type="right" %}

{% include new_feature_row id="feature_row4" type="center" %}
<!-- 
---
layout: archive
title: "People2"
...
title: "People"
layout: splash
permalink: /people-new/
date: 2016-03-23T11:48:41-04:00
header:
  overlay_color: "#000"
  overlay_filter: "0.5"
  overlay_image: images/60605880.jpeg
  actions:
    - label: "Download"
      url: "https://github.com/mmistakes/minimal-mistakes/"
  caption: "Photo credit: [**Unsplash**](https://unsplash.com)"
